    ...
    for frame_idx, (path, im, im0s, vid_cap, s) in enumerate(dataset):
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if show_vid:
                ...
                cv2.line(im0, (25, count_line_position), (1200, count_line_position), (255, 127, 0), 3)
                thickness = 1
                org = (150, 50)
                org_1 =(150,100)
                org_2 = (150,150)
                ...
                cv2.putText(im0, "Total Vehicle count" + text, org, font, fontScale, color,thickness, lineType)
                cv2.putText(im0, "Cars count: " + str(count_car), org_1, font,
                            fontScale, color, thickness, cv2.LINE_AA)
                cv2.putText(im0, "Bus count: " + str(count_bus), org_2, font,
                            fontScale, color, thickness, cv2.LINE_AA)
...
def count_obj(box,w,h,id,_class):
    global count, data, count_car, data_car, count_bus, data_bus
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='bridge.mp4', help='source')  # file/folder, 0 for webcam
